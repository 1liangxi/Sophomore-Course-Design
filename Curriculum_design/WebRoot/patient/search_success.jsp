...
<html>
    ...
    <body>
    <form action="<%=path %>/patient/Patient_searchPatient.action" method="post">
         <input id="search" type="text" placeholder="输入病人编号/病人姓名" name="search" value="<%=session.getAttribute("tj") %>">
    ...
    <form id="myform" action="<%=path %>/patient/Patient_delectAll.action">
        ...
        <div style="margin:0px auto;width:420px;">
            ...
            <span><a href = "../patient/search_success.jsp?pagenum=1" >首页</a></span>
            <span><a href = "../patient/search_success.jsp?pagenum=<%=pagenum-1 %>" >上一页</a></span>
            <span>
		          <input id="pageselect" type="text" name="pagenum" value="<%=pagenum %>" style="width:30px;height:20px;text-align:center;">
		      </span>
            <span><a  href = "../patient/search_success.jsp?&pagenum=<%=1+pagenum %>">下一页</a></span>
            <span><a href = "../patient/search_success.jsp?&pagenum=<%=size/max+1 %>" >尾页</a></span>
